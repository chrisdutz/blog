...
In Christian Glomb's talk (Siemens) at 2021s EclipseCon, he stated that over 50% of each industrial IoT projects costs are data-integration costs. This huge block is what Apache PLC4X aims at eliminating. So generally this hope was justified.
