...
I'll also be starting to implement commercial integration modules that allow using PLC4X in commercial industrial products. These modules will not be open-sourced and not be available for free.

This is my final attempt. If this also doesn't help at getting at least some form of financial attribution for my hard work, I will close down my business and there will be no further form of support from my side.
...
Another thing I'll probably start doing, is writing paid commercial integration modules for IoT platforms with a commercial marketplace system. I'll probably make them available at competitive prices.
