...
There's something big lurking around the corner, that might become an issue soon and which could speed up things.
...
especially those projects that don't have any form of commercial backing.
Otherwise, these will not have the money and power to prepare for coming changes.
Some rules for projects considered `critical infrastructure` - which I have been told, PLC4X and similar projects from the same thematic area possibly will fall under - will most probably require them to execute external code audits in order to be allowed to release software.

Which group of private people will be willing to invest the significant amounts of money in order to pay for something, just to enable others to continue taking their stuff for free?
